                    ...
                    <View style={styles.content}>
                        ...
                        >
                            ...
                            <View style={[styles.imageContainer, this.getStyles().imageContainer]}>
                                <Image source={{ uri: 'https://i.imgur.com/Q0Ysh7L.jpg' }} style={styles.image} />
                            </View>
                            {/* Title and genre */}
                            <View style={[styles.movieInfo, this.getStyles().movieInfo]}>
                                <Text style={[styles.title, this.getStyles().title]}>Sangram</Text>
                                <Text style={styles.genre}>nishant</Text>
                            </View>
                        </View>
